...
<div class="login-container">
	<h2 class="chat-title">ChatFlow</h2>
        <?php if (isset($_GET['error']) && $_GET['error'] == "usuario_existente"): ?>
            <div class="alert alert-danger">El nombre de usuario ya existe. Si es tuyo, <a href="index.php">inicia sesión aquí</a>.</div>
        <?php endif; ?>
    ...
    <form action="bd/adduser.php" method="POST">
        ...
        <div class="mb-3">
            ...
            <span class="form-text text-white infor">Este número será visible para que tus amigos puedan llamarte.</span>
        </div>
        <div class="mb-3">
            <label>Usuario</label>
            <input type="text" name="nombreusu" class="form-control" placeholder="Elija su nombre de usuario" required>
        </div>
        <div class="mb-3">
    ...
    <p class="text-center mt-3">
        ¿Ya tienes una cuenta? <a href="index.php" class="text-danger">Inicia Sesión</a>
    </p>
</div>
